        ...
        switch (this.gamestate) {
            ...
            case GAMESTATE.MOVING:
                ...
                if (this.players.every(this.finished)) {
                    ...
                    console.log(activePlayer.canRoquet);
                    alert("hello");
                    ...
                    this.players.forEach(object => {
                        ...
                        if (object.hitThisTurn && activePlayer.canRoquet[object.name]) {
                ...
                for (let i = 0; i < (this.players.length - 1); i++) {
                    ...
                    if (next.initiated) {
                        ...
                        if (object.distanceFrom(next) <= (2 * object.radius) ** 2) {
                            ...
                            if (activePlayer == object && activePlayer.canRoquet[next.name]) {
                                next.hitThisTurn = true;
                                activePlayer.canRoquet[next.name] = false;
                            }
                            if (activePlayer == next && activePlayer.canRoquet[object.name]) {
                                object.hitThisTurn = true;
                                activePlayer.canRoquet[object] = false;
                            }
